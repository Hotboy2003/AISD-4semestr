# -*- coding: utf-8 -*-
"""
Created on Thu Mar 30 18:17:38 2023

@author: admin
"""
"""
Алгоритм Кнута-Морриса-Пратта (КМП) - это алгоритм, который находит первое вхождение
заданного образца (pattern) в заданной строке-тексте (text). Алгоритм основан на 
использовании префикс-функции, которая для каждой позиции в образце определяет 
длину максимального суффикса, совпадающего с префиксом. С помощью этой функции алгоритм
выполняет поиск образца в строке-тексте за время O(m+n), где m - длина образца, 
n - длина строки-текста.
"""
